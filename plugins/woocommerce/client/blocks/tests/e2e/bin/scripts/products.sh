...
# Set a variable product as having 100 in stock and add some extra data to one of its variations.
...
wp wc product_variation update $hoodie_product_id $hoodie_product_variation_id --manage_stock=true --in_stock=false --weight=2 --dimensions="{ \"length\": \"2\", \"width\": \"3\", \"height\": \"4\" }" --user=1
