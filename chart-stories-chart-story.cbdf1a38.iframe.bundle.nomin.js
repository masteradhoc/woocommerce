...
var ChartPlaceholder = /*#__PURE__*/function (_Component) {
  function ChartPlaceholder() {
    ...
    return _callSuper(this, ChartPlaceholder, arguments);
  }
  (0,inherits/* default */.A)(ChartPlaceholder, _Component);
  return (0,createClass/* default */.A)(ChartPlaceholder, [{
    key: "render",
...
function legend_callSuper(t, o, e) {
  return o = (0,getPrototypeOf/* default */.A)(o), (0,possibleConstructorReturn/* default */.A)(t, legend_isNativeReflectConstruct() ? Reflect.construct(o, e || [], (0,getPrototypeOf/* default */.A)(t).constructor) : o.apply(t, e));
}
...
var D3Legend = /*#__PURE__*/function (_Component) {
  function D3Legend() {
    ...
    _this = legend_callSuper(this, D3Legend);
  ...
  return (0,createClass/* default */.A)(D3Legend, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: (0,clsx/* default */.A)('woocommerce-legend', "woocommerce-legend__direction-".concat(legendDirection), {
...
function d3base_callSuper(t, o, e) {
  return o = (0,getPrototypeOf/* default */.A)(o), (0,possibleConstructorReturn/* default */.A)(t, d3base_isNativeReflectConstruct() ? Reflect.construct(o, e || [], (0,getPrototypeOf/* default */.A)(t).constructor) : o.apply(t, e));
}
function d3base_isNativeReflectConstruct() {
  try {
    var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
  } catch (t) {}
  return (d3base_isNativeReflectConstruct = function _isNativeReflectConstruct() {
    return !!t;
  })();
}
/**
...
var D3Base = /*#__PURE__*/function (_Component) {
  function D3Base(props) {
    ...
    _this = d3base_callSuper(this, D3Base, [props]);
    _this.chartRef = (0,react.createRef)();
    return _this;
  }
  (0,inherits/* default */.A)(D3Base, _Component);
  return (0,createClass/* default */.A)(D3Base, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
var ChartTooltip = /*#__PURE__*/function () {
  ...
  return (0,createClass/* default */.A)(ChartTooltip, [{
...
function chart_callSuper(t, o, e) {
  return o = (0,getPrototypeOf/* default */.A)(o), (0,possibleConstructorReturn/* default */.A)(t, chart_isNativeReflectConstruct() ? Reflect.construct(o, e || [], (0,getPrototypeOf/* default */.A)(t).constructor) : o.apply(t, e));
}
function chart_isNativeReflectConstruct() {
  try {
    var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
  } catch (t) {}
  return (chart_isNativeReflectConstruct = function _isNativeReflectConstruct() {
    return !!t;
  })();
}
/**
...
var D3Chart = /*#__PURE__*/function (_Component) {
  function D3Chart(props) {
    ...
    _this = chart_callSuper(this, D3Chart, [props]);
  ...
  return (0,createClass/* default */.A)(D3Chart, [{
    key: "getFormatParams",
...
function src_chart_callSuper(t, o, e) {
  return o = (0,getPrototypeOf/* default */.A)(o), (0,possibleConstructorReturn/* default */.A)(t, src_chart_isNativeReflectConstruct() ? Reflect.construct(o, e || [], (0,getPrototypeOf/* default */.A)(t).constructor) : o.apply(t, e));
}
function src_chart_isNativeReflectConstruct() {
  try {
    var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
  } catch (t) {}
  return (src_chart_isNativeReflectConstruct = function _isNativeReflectConstruct() {
    return !!t;
  })();
}
/**
...
var Chart = /*#__PURE__*/function (_Component) {
  function Chart(props) {
    ...
    _this = src_chart_callSuper(this, Chart, [props]);
    ...
    _this.handleLegendToggle = _this.handleLegendToggle.bind(_this);
    _this.handleLegendHover = _this.handleLegendHover.bind(_this);
  ...
  return (0,createClass/* default */.A)(Chart, [{
    key: "getDataKeys",
    ...
    value: function render() {
      ...
      var totalLabel = itemsLabel ? (0,build_module/* sprintf */.nv)(itemsLabel, orderedKeys.length) : '';
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [showHeaderControls && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          ...
          component: false,
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            className: (0,clsx/* default */.A)('woocommerce-chart__body', "woocommerce-chart__body-".concat(chartDirection)),
