...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("../../node_modules/.pnpm/@babel+runtime@7.25.7/node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("../../node_modules/.pnpm/@babel+runtime@7.25.7/node_modules/@babel/runtime/helpers/esm/objectWithoutProperties.js");
...
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__("../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs");
...
/* harmony import */ var _wordpress_a11y__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("../../node_modules/.pnpm/@wordpress+a11y@4.0.1/node_modules/@wordpress/a11y/build-module/index.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("../../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/lodash.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("../../packages/js/components/src/sortable/utils.ts");
...
var SortableContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.createContext)({});
var Sortable = function Sortable(_ref) {
  var children = _ref.children,
    ...
    props = (0,_babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A)(_ref, _excluded);
  var ref = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useRef)(null);
  var _useState = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useState)([]),
    _useState2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A)(_useState, 2),
    items = _useState2[0],
    setItems = _useState2[1];
  var _useState3 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useState)(-1),
    _useState4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A)(_useState3, 2),
    selectedIndex = _useState4[0],
    setSelectedIndex = _useState4[1];
  var _useState5 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useState)(null),
    _useState6 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A)(_useState5, 2),
    dragIndex = _useState6[0],
    setDragIndex = _useState6[1];
  var _useState7 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useState)(null),
    _useState8 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A)(_useState7, 2),
  ...
  var persistItemOrder = function persistItemOrder() {
    if (dropIndex !== null && dragIndex !== null && dropIndex !== dragIndex) {
      var nextItems = (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .moveIndex */ .e6)(dragIndex, dropIndex, items);
      setItems(nextItems);
  ...
  var handleDragOver = function handleDragOver(event, index) {
    ...
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .isBefore */ .Y8)(event, isHorizontal)) {
      targetIndex--;
    }
    setDropIndex(targetIndex);
    onDragOver(event);
  };
  var throttledHandleDragOver = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.useCallback)((0,lodash__WEBPACK_IMPORTED_MODULE_18__.throttle)(handleDragOver, THROTTLE_TIME), [dragIndex]);
  var handleKeyDown = function handleKeyDown(event) {
    var key = event.key;
    var isSelecting = dragIndex === null || dropIndex === null;
    var selectedLabel = (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .getItemName */ .H0)(ref.current, selectedIndex);

    // Select or drop on spacebar press.
    if (key === ' ') {
      if (isSelecting) {
        (0,_wordpress_a11y__WEBPACK_IMPORTED_MODULE_17__/* .speak */ .L)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_16__/* .sprintf */ .nv)(/** Translators: Selected item label */
      ...
      (0,_wordpress_a11y__WEBPACK_IMPORTED_MODULE_17__/* .speak */ .L)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_16__/* .sprintf */ .nv)(/* translators: %1$s: Selected item label, %2$d: Current position in list, %3$d: List total length */
    ...
    if (key === 'ArrowUp') {
      if (isSelecting) {
        setSelectedIndex((0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .getPreviousIndex */ .S1)(selectedIndex, items.length));
        return;
      }
      var previousDropIndex = (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .getPreviousIndex */ .S1)(dropIndex, items.length);
    ...
    if (key === 'ArrowDown') {
      if (isSelecting) {
        setSelectedIndex((0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .getNextIndex */ .g0)(selectedIndex, items.length));
        return;
      }
      var nextDropIndex = (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .getNextIndex */ .g0)(dropIndex, items.length);
    ...
    if (key === 'Escape') {
      resetIndexes();
      (0,_wordpress_a11y__WEBPACK_IMPORTED_MODULE_17__/* .speak */ .L)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_16__.__)('Reordering cancelled. Restoring the original list order', 'woocommerce'), 'assertive');
    }
  };
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_19__.jsx)(SortableContext.Provider, {
    value: {},
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_19__.jsx)("div", _objectSpread(_objectSpread({}, props), {}, {
      className: (0,clsx__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A)('woocommerce-sortable', className, {
      ...
      children: items.map(function (child, index) {
        ...
        var itemClasses = (0,clsx__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A)(child.props.className, {
          'is-dragging-over-after': (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .isDraggingOverAfter */ .Km)(index, dragIndex, dropIndex),
          'is-dragging-over-before': (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .isDraggingOverBefore */ .PZ)(index, dragIndex, dropIndex),
          'is-last-droppable': (0,_utils__WEBPACK_IMPORTED_MODULE_23__/* .isLastDroppable */ .Ib)(index, dragIndex, items.length)
        });
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_20__.cloneElement)(child, {
          key: child.key || index,
