(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[4683],{
...
// UNUSED EXPORTS: COUNTRIES_STORE_NAME, DAY, EXPERIMENTAL_PRODUCT_ATTRIBUTES_STORE_NAME, EXPERIMENTAL_PRODUCT_ATTRIBUTE_TERMS_STORE_NAME, EXPERIMENTAL_PRODUCT_CATEGORIES_STORE_NAME, EXPERIMENTAL_PRODUCT_FORM_STORE_NAME, EXPERIMENTAL_PRODUCT_SHIPPING_CLASSES_STORE_NAME, EXPERIMENTAL_PRODUCT_TAGS_STORE_NAME, EXPERIMENTAL_PRODUCT_VARIATIONS_STORE_NAME, EXPERIMENTAL_SHIPPING_ZONES_STORE_NAME, EXPERIMENTAL_TAX_CLASSES_STORE_NAME, EXPORT_STORE_NAME, EnableGatewayResponse, HOUR, IMPORT_STORE_NAME, ITEMS_STORE_NAME, MAX_PER_PAGE, MINUTE, MONTH, NAMESPACE, NAVIGATION_STORE_NAME, NOTES_STORE_NAME, ONBOARDING_STORE_NAME, OPTIONS_STORE_NAME, ORDERS_STORE_NAME, OfflinePaymentMethodProvider, OfflinePmsGroupProvider, OnboardingSelectors, PAYMENT_GATEWAYS_STORE_NAME, PAYMENT_SETTINGS_STORE_NAME, PLUGINS_STORE_NAME, PRODUCTS_STORE_NAME, PaymentGateway, PaymentGatewayProvider, PaymentSelectors, PaymentSettingsSelectors, PaymentsEntity, PaymentsExtensionSuggestionProvider, PaymentsProvider, PaymentsProviderIncentive, PaymentsProviderLink, PaymentsProviderOnboardingState, PaymentsProviderState, PaymentsProviderType, PluginActions, PluginData, PluginSelectors, PluginsStoreActions, ProductAttribute, ProductAttributeSelectors, ProductAttributeTerm, ProductAttributeTermsActions, ProductAttributeTermsSelectors, ProductAttributesActions, ProductCategory, ProductCategoryActions, ProductCategoryImage, ProductCategorySelectors, ProductForm, ProductFormField, ProductFormSection, ProductShippingClassesActions, ProductTag, ProductTagsActions, ProductVariationsActions, ProductsStoreActions, QUERY_DEFAULTS, Query, QueryProductAttribute, REPORTS_STORE_NAME, REVIEWS_STORE_NAME, RecommendedPaymentMethod, SECOND, SETTINGS_STORE_NAME, SHIPPING_METHODS_STORE_NAME, Setting, SettingType, SettingValue, SettingsGroup, ShippingMethod, ShippingZonesActions, SuggestedPaymentsExtension, SuggestedPaymentsExtensionCategory, TaxClass, TaxClassActions, USER_STORE_NAME, UserPreferences, WCS_NAMESPACE, WCUser, WC_ADMIN_NAMESPACE, WEEK, WOOPAYMENTS_ONBOARDING_STORE_NAME, WooPaymentsOnboardingSelectors, countriesStore, experimentalProductAttributeTermsStore, experimentalProductAttributesStore, experimentalProductCategoriesStore, experimentalProductFormStore, experimentalProductShippingClassesStore, experimentalProductTagsStore, experimentalProductVariationsStore, experimentalSettingOptionsStore, experimentalShippingZonesStore, experimentalTaxClassesStore, getFilterQuery, getLeaderboard, getReportChartData, getReportTableData, getReportTableQuery, getSummaryNumbers, getTooltipValueFormat, getVisibleTasks, importStore, isRestApiError, itemsStore, notesStore, onboardingStore, ordersStore, paymentGatewaysStore, paymentSettingsStore, pluginNames, pluginsStore, productReadOnlyProperties, productsStore, reportsStore, reviewsStore, searchItemsByString, settingsStore, shippingMethodsStore, useOptionsHydration, useSettings, userStore, withCurrentUserHydration, withNavigationHydration, withOnboardingHydration, withOptionsHydration, withPluginsHydration, withSettingsHydration, woopaymentsOnboardingStore
...
__webpack_require__.d(payment_settings_actions_namespaceObject, {
  attachPaymentExtensionSuggestion: () => (attachPaymentExtensionSuggestion),
...
__webpack_require__.d(payment_settings_selectors_namespaceObject, {
  ...
  getSuggestionCategories: () => (selectors_getSuggestionCategories),
  getSuggestions: () => (selectors_getSuggestions),
...
// NAMESPACE OBJECT: ../../packages/js/data/src/woopayments-onboarding/selectors.ts
var woopayments_onboarding_selectors_namespaceObject = {};
__webpack_require__.r(woopayments_onboarding_selectors_namespaceObject);
__webpack_require__.d(woopayments_onboarding_selectors_namespaceObject, {
  getOnboardingData: () => (getOnboardingData),
  getOnboardingDataError: () => (getOnboardingDataError),
  isOnboardingDataRequestPending: () => (isOnboardingDataRequestPending)
});

// NAMESPACE OBJECT: ../../packages/js/data/src/woopayments-onboarding/actions.ts
var woopayments_onboarding_actions_namespaceObject = {};
__webpack_require__.r(woopayments_onboarding_actions_namespaceObject);
__webpack_require__.d(woopayments_onboarding_actions_namespaceObject, {
  getOnboardingDataError: () => (actions_getOnboardingDataError),
  getOnboardingDataRequest: () => (getOnboardingDataRequest),
  getOnboardingDataSuccess: () => (getOnboardingDataSuccess)
});

// NAMESPACE OBJECT: ../../packages/js/data/src/woopayments-onboarding/resolvers.ts
var woopayments_onboarding_resolvers_namespaceObject = {};
__webpack_require__.r(woopayments_onboarding_resolvers_namespaceObject);
__webpack_require__.d(woopayments_onboarding_resolvers_namespaceObject, {
  getOnboardingData: () => (resolvers_getOnboardingData)
});
...
// NAMESPACE OBJECT: ../../packages/js/data/src/setting-options/selectors.ts
var setting_options_selectors_namespaceObject = {};
__webpack_require__.r(setting_options_selectors_namespaceObject);
__webpack_require__.d(setting_options_selectors_namespaceObject, {
  getEditedSettingIds: () => (getEditedSettingIds),
  getGroup: () => (getGroup),
  getGroupError: () => (getGroupError),
  getGroups: () => (getGroups),
  getSetting: () => (selectors_getSetting),
  getSettingError: () => (getSettingError),
  getSettingValue: () => (getSettingValue),
  getSettings: () => (selectors_getSettings),
  hasEditsForGroup: () => (hasEditsForGroup),
  isGroupSaving: () => (isGroupSaving),
  isSettingEdited: () => (isSettingEdited),
  isSettingSaving: () => (isSettingSaving)
});

// NAMESPACE OBJECT: ../../packages/js/data/src/setting-options/actions.ts
var setting_options_actions_namespaceObject = {};
__webpack_require__.r(setting_options_actions_namespaceObject);
__webpack_require__.d(setting_options_actions_namespaceObject, {
  __unstableAcquireStoreLock: () => (__unstableAcquireStoreLock),
  __unstableReleaseStoreLock: () => (__unstableReleaseStoreLock),
  editSetting: () => (editSetting),
  editSettings: () => (editSettings),
  receiveGroups: () => (receiveGroups),
  receiveSettings: () => (receiveSettings),
  revertEditedSetting: () => (revertEditedSetting),
  revertEditedSettingsGroup: () => (revertEditedSettingsGroup),
  saveEditedSetting: () => (saveEditedSetting),
  saveEditedSettingsGroup: () => (saveEditedSettingsGroup),
  saveSetting: () => (saveSetting),
  saveSettingsGroup: () => (saveSettingsGroup),
  setError: () => (setting_options_actions_setError),
  setSaving: () => (setSaving)
});

// NAMESPACE OBJECT: ../../packages/js/data/src/setting-options/resolvers.ts
var setting_options_resolvers_namespaceObject = {};
__webpack_require__.r(setting_options_resolvers_namespaceObject);
__webpack_require__.d(setting_options_resolvers_namespaceObject, {
  getGroups: () => (resolvers_getGroups),
  getSetting: () => (resolvers_getSetting),
  getSettingValue: () => (resolvers_getSettingValue),
  getSettings: () => (setting_options_resolvers_getSettings)
});
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+core-data@7.0.7_@emotion+is-prop-valid@1.2.1_@types+react-dom@18.3.0_@types+react@_fji74ey7w7dkuq6v6jv47rw5xa/node_modules/@wordpress/core-data/build-module/index.js + 82 modules
...
;// ../../packages/js/data/src/settings/constants.ts
...
;// ../../packages/js/data/src/controls.ts
...
;// ../../packages/js/data/src/user/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/settings/selectors.ts
...
;// ../../packages/js/data/src/constants.ts
...
;// ../../packages/js/data/src/settings/action-types.ts
var TYPES = {
...
;// ../../packages/js/data/src/settings/actions.ts
...
;// ../../packages/js/data/src/settings/resolvers.ts
...
;// ../../packages/js/data/src/settings/reducer.ts
...
;// ../../packages/js/data/src/settings/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/plugins/constants.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/plugins/selectors.ts
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@babel+runtime@7.25.7/node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js + 3 modules
var wrapNativeSuper = __webpack_require__("../../node_modules/.pnpm/@babel+runtime@7.25.7/node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js");
...
;// ../../packages/js/data/src/plugins/action-types.ts
...
;// ../../packages/js/data/src/plugins/actions.ts
...
var PluginError = /*#__PURE__*/function (_Error) {
  function PluginError(message, data) {
    ...
    _this = _callSuper(this, PluginError, [message]);
    _this.data = data;
    return _this;
  }
...
function installAndActivatePlugins(plugins, source) {
  var installations, activations, response, _activations$data$plu, plugin_slug, plugin, _activations$data$plu2, _plugin_slug, _plugin;
  return regenerator_default().wrap(function installAndActivatePlugins$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        _context4.prev = 0;
        _context4.next = 3;
        return controls/* controls */.n.dispatch(plugins_constants_STORE_NAME, 'installPlugins', plugins, false, source);
      case 3:
      ...
      case 6:
        ...
        installations.success && !Object.keys(installations.data.results).length && activations.success && activations.data.activated.length === 1) {
          _plugin_slug = activations.data.activated[0];
          _plugin = (_activations$data$plu2 = activations.data.plugin_details) === null || _activations$data$plu2 === void 0 ? void 0 : _activations$data$plu2[_plugin_slug];
          if (_plugin) {
            response.message = (0,i18n_build_module/* sprintf */.nv)(/* translators: %1$s: plugin name */
            (0,i18n_build_module.__)('%1$s was successfully activated.', 'woocommerce'), _plugin.name);
          } else {
            response.message = (0,i18n_build_module.__)('A plugin was successfully activated.', 'woocommerce');
          }
        }
...
// Types
;// ../../packages/js/data/src/options/constants.ts
var options_constants_STORE_NAME = 'wc/admin/options';
;// ../../packages/js/data/src/options/selectors.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/options/action-types.ts
...
;// ../../packages/js/data/src/options/actions.ts
...
;// ../../packages/js/data/src/options/utils.ts
...
;// ../../packages/js/data/src/options/controls.ts
...
;// ../../packages/js/data/src/options/resolvers.ts
...
;// ../../packages/js/data/src/options/reducer.ts
...
;// ../../packages/js/data/src/options/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/plugins/resolvers.ts
...
;// ../../packages/js/data/src/plugins/reducer.ts
...
;// ../../packages/js/data/src/plugins/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/onboarding/constants.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/onboarding/selectors.ts
...
;// ../../packages/js/data/src/onboarding/action-types.ts
...
;// ../../packages/js/data/src/onboarding/deprecated-tasks.ts
...
var DeprecatedTasks = /*#__PURE__*/function () {
  ...
  return (0,createClass/* default */.A)(DeprecatedTasks, [{
...
;// ../../packages/js/data/src/onboarding/actions.ts
...
;// ../../packages/js/data/src/onboarding/resolvers.ts
...
;// ../../packages/js/data/src/onboarding/reducer.ts
...
;// ../../packages/js/data/src/onboarding/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/reviews/constants.ts
var reviews_constants_STORE_NAME = 'wc/admin/reviews';
;// ../../packages/js/data/src/reviews/selectors.ts
...
var getReview = function getReview(state, id) {
  return state.data[id];
};
...
var getReviewError = function getReviewError(state, id) {
  return state.errors[id];
};
;// ../../packages/js/data/src/reviews/action-types.ts
...
;// ../../packages/js/data/src/reviews/actions.ts
...
;// ../../packages/js/data/src/reviews/resolvers.ts


var reviews_resolvers_marked = /*#__PURE__*/regenerator_default().mark(resolvers_getReviews),
  reviews_resolvers_marked2 = /*#__PURE__*/regenerator_default().mark(resolvers_getReview),
  reviews_resolvers_marked3 = /*#__PURE__*/regenerator_default().mark(resolvers_getReviewsTotalCount);
...
function resolvers_getReview(id) {
  var url, response;
  return regenerator_default().wrap(function getReview$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        url = (0,add_query_args/* addQueryArgs */.F)("wc/v3/products/reviews/".concat(id));
        _context2.next = 4;
        return fetchWithHeaders({
          path: url,
          method: 'GET'
      ...
      case 4:
        response = _context2.sent;
        _context2.next = 7;
        return setReview(id, response.data);
      case 7:
        _context2.next = 13;
        break;
      case 9:
        ...
        _context2.t0 = _context2["catch"](0);
        _context2.next = 13;
        return reviews_actions_setError(JSON.stringify(id), _context2.t0);
      case 13:
      case "end":
        return _context2.stop();
    }
  }, reviews_resolvers_marked2, null, [[0, 9]]);
}
function resolvers_getReviewsTotalCount(query) {
  ...
  }, reviews_resolvers_marked3);
}
;// ../../packages/js/data/src/reviews/reducer.ts
...
;// ../../packages/js/data/src/reviews/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/notes/constants.ts
/**
 * Internal dependencies
 */
var notes_constants_STORE_NAME = 'wc/admin/notes';
;// ../../packages/js/data/src/notes/selectors.ts
...
;// ../../packages/js/data/src/notes/action-types.ts
...
;// ../../packages/js/data/src/notes/actions.ts
...
;// ../../packages/js/data/src/notes/resolvers.ts
...
;// ../../packages/js/data/src/notes/reducer.ts
...
;// ../../packages/js/data/src/notes/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/reports/constants.ts
/**
 * Internal dependencies
 */
var reports_constants_STORE_NAME = 'wc/admin/reports';
;// ../../packages/js/data/src/reports/selectors.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/reports/action-types.ts
...
;// ../../packages/js/data/src/reports/actions.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/reports/resolvers.ts
...
;// ../../packages/js/data/src/reports/reducer.ts
...
;// ../../packages/js/data/src/reports/index.ts
/**
 * External dependencies
 */
...
var reports_store = (0,redux_store/* default */.A)(reports_constants_STORE_NAME, {
...
(0,data_build_module/* register */.kz)(reports_store);
 ...
 */
;// ../../packages/js/data/src/countries/constants.ts
var countries_constants_STORE_NAME = 'wc/admin/countries';
;// ../../packages/js/data/src/countries/selectors.ts
...
;// ../../packages/js/data/src/countries/action-types.ts
...
;// ../../packages/js/data/src/countries/actions.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/countries/resolvers.ts
...
;// ../../packages/js/data/src/countries/reducer.ts
...
;// ../../packages/js/data/src/countries/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/items/constants.ts
...
;// ../../packages/js/data/src/items/actions.ts
...
var items_store = (0,redux_store/* default */.A)(items_constants_STORE_NAME, {
...
(0,data_build_module/* register */.kz)(items_store);
var ITEMS_STORE_NAME = (/* unused pure expression or super */ null && (STORE_NAME));

// We need to provide those types to support type parameters in the selectors.
;// ../../packages/js/data/src/payment-gateways/action-types.ts
...
;// ../../packages/js/data/src/payment-gateways/resolvers.ts
...
;// ../../packages/js/data/src/payment-gateways/selectors.ts
...
;// ../../packages/js/data/src/payment-gateways/reducer.ts
...
;// ../../packages/js/data/src/payment-gateways/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/payment-settings/actions.ts


var payment_settings_actions_marked = /*#__PURE__*/regenerator_default().mark(togglePaymentGateway),
  payment_settings_actions_marked2 = /*#__PURE__*/regenerator_default().mark(attachPaymentExtensionSuggestion),
  payment_settings_actions_marked3 = /*#__PURE__*/regenerator_default().mark(hidePaymentExtensionSuggestion);
...
function attachPaymentExtensionSuggestion(url) {
  var result;
  return regenerator_default().wrap(function attachPaymentExtensionSuggestion$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        _context2.next = 3;
...
function hidePaymentExtensionSuggestion(url) {
  var result;
  return regenerator_default().wrap(function hidePaymentExtensionSuggestion$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        _context3.prev = 0;
        _context3.next = 3;
  ...
  }, payment_settings_actions_marked3, null, [[0, 7]]);
}
...
;// ../../packages/js/data/src/payment-settings/constants.ts
var payment_settings_constants_STORE_KEY = 'wc/admin/payment-settings';
;// ../../packages/js/data/src/payment-settings/resolvers.ts
var _controls$resolveSele;


var payment_settings_resolvers_marked = /*#__PURE__*/regenerator_default().mark(getPaymentProviders),
  payment_settings_resolvers_marked2 = /*#__PURE__*/regenerator_default().mark(getPaymentProvidersIfNeeded),
  payment_settings_resolvers_marked3 = /*#__PURE__*/regenerator_default().mark(getOfflinePaymentGateways),
  payment_settings_resolvers_marked4 = /*#__PURE__*/regenerator_default().mark(getSuggestions),
  payment_settings_resolvers_marked5 = /*#__PURE__*/regenerator_default().mark(getSuggestionCategories),
  payment_settings_resolvers_marked6 = /*#__PURE__*/regenerator_default().mark(getWooPayEligibility),
  payment_settings_resolvers_marked7 = /*#__PURE__*/regenerator_default().mark(getIsWooPayEligible);
/**
 * External dependencies
 */
...
var payment_settings_resolvers_resolveSelect = (_controls$resolveSele = controls/* controls */.n === null || controls/* controls */.n === void 0 ? void 0 : controls/* controls */.n.resolveSelect) !== null && _controls$resolveSele !== void 0 ? _controls$resolveSele : data_controls_build_module/* select */.Lt;
  ...
  return regenerator_default().wrap(function getPaymentProviders$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 2:
        ...
        return (0,data_controls_build_module/* apiFetch */.nr)({
          method: 'POST',
          // Use the not-so-semantic POST to avoid caching of response.
...
function getPaymentProvidersIfNeeded(businessCountry) {
  return regenerator_default().wrap(function getPaymentProvidersIfNeeded$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.next = 2;
        return payment_settings_resolvers_resolveSelect(payment_settings_constants_STORE_KEY, 'getPaymentProviders', businessCountry);
      case 2:
      case "end":
        return _context2.stop();
    }
...
function getOfflinePaymentGateways(businessCountry) {
  return regenerator_default().wrap(function getOfflinePaymentGateways$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        _context3.next = 2;
        return getPaymentProvidersIfNeeded(businessCountry);
      case 2:
      case "end":
        return _context3.stop();
    }
...
function getSuggestions(businessCountry) {
  return regenerator_default().wrap(function getSuggestions$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      case 0:
        _context4.next = 2;
        return getPaymentProvidersIfNeeded(businessCountry);
...
function getSuggestionCategories(businessCountry) {
  return regenerator_default().wrap(function getSuggestionCategories$(_context5) {
    while (1) switch (_context5.prev = _context5.next) {
      case 0:
        _context5.next = 2;
        return getPaymentProvidersIfNeeded(businessCountry);
  ...
  }, payment_settings_resolvers_marked5);
}
function getWooPayEligibility() {
  var response;
  return regenerator_default().wrap(function getWooPayEligibility$(_context6) {
    while (1) switch (_context6.prev = _context6.next) {
      case 0:
        _context6.next = 2;
        return (0,data_controls_build_module/* apiFetch */.nr)({
          method: 'POST',
          path: "".concat(WC_ADMIN_NAMESPACE, "/settings/payments/woopayments/woopay-eligibility")
        });
      case 2:
  ...
  }, payment_settings_resolvers_marked6);
}
function getIsWooPayEligible() {
  var response;
  return regenerator_default().wrap(function getIsWooPayEligible$(_context7) {
    while (1) switch (_context7.prev = _context7.next) {
      case 0:
        _context7.next = 2;
  ...
  }, payment_settings_resolvers_marked7);
}
;// ../../packages/js/data/src/payment-settings/selectors.ts
/**
 * Internal dependencies
 */
...
function selectors_getSuggestions(state,
// eslint-disable-next-line @typescript-eslint/no-unused-vars
businessCountry) {
  return state.suggestions;
}
function selectors_getSuggestionCategories(state,
// eslint-disable-next-line @typescript-eslint/no-unused-vars
businessCountry) {
...
;// ../../packages/js/data/src/payment-settings/reducer.ts
...
;// ../../packages/js/data/src/shipping-methods/action-types.ts
...
;// ../../packages/js/data/src/shipping-methods/actions.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/shipping-methods/resolvers.ts
...
;// ../../packages/js/data/src/shipping-methods/selectors.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/shipping-methods/reducer.ts
...
;// ../../packages/js/data/src/shipping-methods/constants.ts
var shipping_methods_constants_STORE_KEY = 'wc/shipping-methods';
;// ../../packages/js/data/src/shipping-methods/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/products/constants.ts
...
;// ../../packages/js/data/src/products/utils.ts
...
;// ../../packages/js/data/src/products/resolvers.ts
...
;// ../../packages/js/data/src/products/index.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/orders/selectors.ts
...
;// ../../packages/js/data/src/orders/action-types.ts
...
;// ../../packages/js/data/src/orders/actions.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/orders/resolvers.ts
...
;// ../../packages/js/data/src/product-attributes/constants.ts
...
var toArray = __webpack_require__("../../node_modules/.pnpm/@babel+runtime@7.25.7/node_modules/@babel/runtime/helpers/esm/toArray.js");
...
;// ../../packages/js/data/src/crud/crud-actions.ts
...
;// ../../packages/js/data/src/crud/utils.ts
...
;// ../../packages/js/data/src/crud/selectors.ts
...
;// ../../packages/js/data/src/crud/action-types.ts
...
;// ../../packages/js/data/src/crud/actions.ts
...
;// ../../packages/js/data/src/crud/resolvers.ts
...
function resolvers_createForOfIteratorHelper(r, e) {
  var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"];
  if (!t) {
    if (Array.isArray(r) || (t = resolvers_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) {
      t && (r = t);
      var _n = 0,
        F = function F() {};
      return {
...
function resolvers_unsupportedIterableToArray(r, a) {
  if (r) {
    if ("string" == typeof r) return resolvers_arrayLikeToArray(r, a);
    var t = {}.toString.call(r).slice(8, -1);
    return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? resolvers_arrayLikeToArray(r, a) : void 0;
  }
}
function resolvers_arrayLikeToArray(r, a) {
  (null == a || a > r.length) && (a = r.length);
  for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e];
  return n;
}
...
;// ../../packages/js/data/src/crud/reducer.ts
...
;// ../../packages/js/data/src/crud/index.ts
...
;// ../../packages/js/data/src/product-attributes/index.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-shipping-classes/constants.ts
...
;// ../../packages/js/data/src/product-shipping-classes/index.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/shipping-zones/constants.ts
...
;// ../../packages/js/data/src/shipping-zones/index.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-categories/constants.ts
...
;// ../../packages/js/data/src/product-categories/index.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-attribute-terms/constants.ts
...
;// ../../packages/js/data/src/product-attribute-terms/index.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-variations/constants.ts
...
;// ../../packages/js/data/src/product-variations/action-types.ts
...
;// ../../packages/js/data/src/product-variations/crud-actions.ts
...
;// ../../packages/js/data/src/product-variations/actions.ts
...
;// ../../packages/js/data/src/product-variations/selectors.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-variations/reducer.ts
...
;// ../../packages/js/data/src/product-variations/index.ts
/**
 * External dependencies
 */
...
var PaymentsProviderType = /*#__PURE__*/function (PaymentsProviderType) {
  PaymentsProviderType["OfflinePmsGroup"] = "offline_pms_group";
  PaymentsProviderType["OfflinePm"] = "offline_pm";
  PaymentsProviderType["Suggestion"] = "suggestion";
  PaymentsProviderType["Gateway"] = "gateway";
  return PaymentsProviderType;
}({});
...
;// ../../packages/js/data/src/product-form/constants.ts
var product_form_constants_STORE_NAME = 'experimental/wc/admin/product-form';
;// ../../packages/js/data/src/product-form/selectors.ts
...
;// ../../packages/js/data/src/product-form/action-types.ts
...
;// ../../packages/js/data/src/product-form/actions.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/product-form/resolvers.ts
...
;// ../../packages/js/data/src/product-form/reducer.ts
...
;// ../../packages/js/data/src/product-form/index.ts
/**
 * External dependencies
 */
...
function woopayments_onboarding_reducer_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function woopayments_onboarding_reducer_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? woopayments_onboarding_reducer_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : woopayments_onboarding_reducer_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
...
var woopayments_onboarding_reducer_initialState = {
  steps: [],
  context: {},
  isFetching: false,
  errors: {}
};
var woopayments_onboarding_reducer_reducer = function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : woopayments_onboarding_reducer_initialState;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  switch (action.type) {
    case 'GET_WOOPAYMENTS_ONBOARDING_DATA_REQUEST':
      return woopayments_onboarding_reducer_objectSpread(woopayments_onboarding_reducer_objectSpread({}, state), {}, {
        isFetching: true
      });
    ...
    case 'GET_WOOPAYMENTS_ONBOARDING_DATA_ERROR':
      return woopayments_onboarding_reducer_objectSpread(woopayments_onboarding_reducer_objectSpread({}, state), {}, {
        errors: woopayments_onboarding_reducer_objectSpread(woopayments_onboarding_reducer_objectSpread({}, state.errors), {}, {
...
/* harmony default export */ const woopayments_onboarding_reducer = (woopayments_onboarding_reducer_reducer);
;// ../../packages/js/data/src/woopayments-onboarding/selectors.ts
/**
 * Internal dependencies
 */

var getOnboardingData = function getOnboardingData(state, sessionEntryPoint) {
  return state;
};
var isOnboardingDataRequestPending = function isOnboardingDataRequestPending(state) {
  return state.isFetching;
};
var getOnboardingDataError = function getOnboardingDataError(state) {
  return state.errors.getOnboardingData;
};
...
function actions_getOnboardingDataError(error) {
  return {
...
var woopayments_onboarding_constants_STORE_KEY = 'wc/admin/woopayments-onboarding';
;// ../../packages/js/data/src/woopayments-onboarding/resolvers.ts


var woopayments_onboarding_resolvers_marked = /*#__PURE__*/regenerator_default().mark(resolvers_getOnboardingData);
/**
 * External dependencies
 */
...
function resolvers_getOnboardingData(sessionEntryPoint) {
  var isFetchingData, response;
  return regenerator_default().wrap(function getOnboardingData$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return (0,data_controls_build_module/* select */.Lt)(woopayments_onboarding_constants_STORE_KEY, 'isOnboardingDataRequestPending');
      case 2:
        isFetchingData = _context.sent;
        if (!isFetchingData) {
          _context.next = 5;
          break;
        }
      ...
      case 5:
        _context.next = 7;
        return getOnboardingDataRequest();
      case 7:
        _context.prev = 7;
        _context.next = 10;
        return (0,data_controls_build_module/* apiFetch */.nr)({
          method: 'POST',
          // Use the not-so-semantic POST to avoid caching of response.
          path: "".concat(WC_ADMIN_NAMESPACE, "/settings/payments/woopayments/onboarding"),
          data: sessionEntryPoint ? {
      ...
      case 10:
        response = _context.sent;
        _context.next = 13;
        return getOnboardingDataSuccess(response);
      case 13:
        _context.next = 19;
        break;
      case 15:
        ...
        _context.next = 19;
        return actions_getOnboardingDataError(_context.t0);
      case 19:
      case "end":
        return _context.stop();
    }
  }, woopayments_onboarding_resolvers_marked, null, [[7, 15]]);
}
...
var WOOPAYMENTS_ONBOARDING_STORE_NAME = (/* unused pure expression or super */ null && (STORE_KEY));
var woopayments_onboarding_store = (0,redux_store/* default */.A)(woopayments_onboarding_constants_STORE_KEY, {
  reducer: woopayments_onboarding_reducer,
  actions: woopayments_onboarding_actions_namespaceObject,
  controls: data_controls_build_module/* controls */.ne,
  selectors: woopayments_onboarding_selectors_namespaceObject,
  resolvers: woopayments_onboarding_resolvers_namespaceObject
});
(0,data_build_module/* register */.kz)(woopayments_onboarding_store);
;// ../../packages/js/data/src/import/constants.ts
/**
 * Internal dependencies
 */
var import_constants_STORE_NAME = 'wc/admin/import';
;// ../../packages/js/data/src/import/selectors.ts
...
;// ../../packages/js/data/src/import/action-types.ts
...
;// ../../packages/js/data/src/import/actions.ts
...
;// ../../packages/js/data/src/import/resolvers.ts
...
function setting_options_selectors_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function setting_options_selectors_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? setting_options_selectors_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : setting_options_selectors_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
 ...
 */
var getGroup = function getGroup(state, groupId) {
...
var setting_options_selectors_EMPTY_OBJECT = {};
 ...
 */
var selectors_getSettings = (0,rememo/* default */.A)(function (state, groupId) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {
    includeEdits: false
  };
  var groupSettings = state.settings[groupId];
  if (!groupSettings) {
    return setting_options_selectors_EMPTY_OBJECT;
  }
  ...
  var groupEdits = state.edits[groupId];
  if (!groupEdits) {
    return groupSettings;
  }

  // Create a new object with all settings, applying edits where they exist
  return Object.keys(groupSettings).reduce(function (result, settingId) {
    var setting = groupSettings[settingId];

    // If this setting has an edit, apply it
    if (settingId in groupEdits) {
      result[settingId] = setting_options_selectors_objectSpread(setting_options_selectors_objectSpread({}, setting), {}, {
...
}, function (state, groupId) {
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {
    includeEdits: false
  };
  return [state.settings[groupId], state.edits[groupId], options.includeEdits];
});
 ...
 */
var selectors_getSetting = (0,rememo/* default */.A)(function (state, groupId, settingId) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {
    includeEdits: false
  };
  var groupSettings = state.settings[groupId];
  ...
  if (groupEdits && settingId in groupEdits) {
    return setting_options_selectors_objectSpread(setting_options_selectors_objectSpread({}, setting), {}, {
      value: groupEdits[settingId]
    });
  }
  return setting;
}, function (state, groupId, settingId) {
  var _state$settings$group, _state$edits$groupId;
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {
    includeEdits: false
  };
  return [(_state$settings$group = state.settings[groupId]) === null || _state$settings$group === void 0 ? void 0 : _state$settings$group[settingId], (_state$edits$groupId = state.edits[groupId]) === null || _state$edits$groupId === void 0 ? void 0 : _state$edits$groupId[settingId], options.includeEdits];
});
 ...
 */
var getSettingValue = function getSettingValue(state, groupId, settingId) {
  var _groupSettings$settin;
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {
    includeEdits: false
  };
  ...
  return (_groupSettings$settin = groupSettings[settingId]) === null || _groupSettings$settin === void 0 ? void 0 : _groupSettings$settin.value;
};
 ...
 */
var isSettingEdited = function isSettingEdited(state, groupId, settingId) {
  var groupEdits = state.edits[groupId];
 ...
 * @param {string}        groupId - The ID of the group to get settings for.
 */
var getEditedSettingIds = (0,rememo/* default */.A)(function (state, groupId) {
  var groupEdits = state.edits[groupId];
  if (!groupEdits) {
    return [];
  }
 ...
 */
var isGroupSaving = function isGroupSaving(state, groupId) {
  var _state$isSaving$group;
  return !!((_state$isSaving$group = state.isSaving.groups) !== null && _state$isSaving$group !== void 0 && _state$isSaving$group[groupId]);
};
 ...
 * @param {string}        settingId - The ID of the setting to check.
 */
var isSettingSaving = function isSettingSaving(state, groupId, settingId) {
  var _state$isSaving$setti;
  var groupSaving = (_state$isSaving$setti = state.isSaving.settings) === null || _state$isSaving$setti === void 0 ? void 0 : _state$isSaving$setti[groupId];
 ...
 */
var getGroupError = function getGroupError(state, groupId) {
 ...
 */
var getSettingError = function getSettingError(state, groupId, settingId) {
  var groupErrors = state.errors[groupId];
  if (!groupErrors) {
    return undefined;
  }
 ...
 * @param {string}        groupId - The ID of the group to check.
 */
var hasEditsForGroup = function hasEditsForGroup(state, groupId) {
  var groupEdits = state.edits[groupId];
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+core-data@7.0.7_@emotion+is-prop-valid@1.2.1_@types+react-dom@18.3.0_@types+react@_fji74ey7w7dkuq6v6jv47rw5xa/node_modules/@wordpress/core-data/build/locks/actions.js
var actions = __webpack_require__("../../node_modules/.pnpm/@wordpress+core-data@7.0.7_@emotion+is-prop-valid@1.2.1_@types+react-dom@18.3.0_@types+react@_fji74ey7w7dkuq6v6jv47rw5xa/node_modules/@wordpress/core-data/build/locks/actions.js");
;// ../../packages/js/data/src/setting-options/action-types.ts
var setting_options_action_types_TYPES = {
...
var receiveGroups = function receiveGroups(groups) {
  return {
    type: setting_options_action_types_TYPES.RECEIVE_GROUPS,
    groups: groups
  };
};
 ...
 * @return The action object.
 */
var receiveSettings = function receiveSettings(groupId, settings) {
  return {
    type: setting_options_action_types_TYPES.RECEIVE_SETTINGS,
    groupId: groupId,
    settings: settings
  };
};
 ...
 */
var createEditSettingAction = function createEditSettingAction(groupId, settingId, value) {
  return {
    type: setting_options_action_types_TYPES.EDIT_SETTING,
    groupId: groupId,
    settingId: settingId,
    value: value
  };
 ...
 * @param value     - The new setting value
 */
var editSetting = function editSetting(groupId, settingId, value) {
  return /*#__PURE__*/function () {
    var _ref2 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee(_ref) {
      var resolveSelect, dispatch;
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            resolveSelect = _ref.resolveSelect, dispatch = _ref.dispatch;
            _context.next = 3;
            return resolveSelect.getSettingValue(groupId, settingId);
          case 3:
 ...
 */
var createEditSettingsAction = function createEditSettingsAction(groupId, updates) {
  return {
    type: setting_options_action_types_TYPES.EDIT_SETTINGS,
    groupId: groupId,
    updates: updates
  };
};
 ...
 */
var validateSettingEdit = function validateSettingEdit(edit) {
  return typeof edit.id === 'string' && edit.id.length > 0 && edit.value !== undefined;
};
 ...
 * @param updates - Array of setting updates or object with setting IDs as keys and values as values
 */
var editSettings = function editSettings(groupId, updates) {
  return /*#__PURE__*/function () {
    var _ref4 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee2(_ref3) {
      var resolveSelect, dispatch, updatesArray;
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            resolveSelect = _ref3.resolveSelect, dispatch = _ref3.dispatch;
            _context2.next = 3;
            return resolveSelect.getSettings(groupId);
          case 3:
            // Convert object format to array format if needed
            updatesArray = Array.isArray(updates) ? updates : Object.entries(updates).map(function (_ref5) {
 ...
 * @return The action object.
 */
var setSaving = function setSaving(groupId, settingId, isSaving) {
  return {
    type: setting_options_action_types_TYPES.SET_SAVING,
    groupId: groupId,
    settingId: settingId,
    isSaving: isSaving
  };
 ...
 * @return The action object.
 */
var setting_options_actions_setError = function setError(groupId, settingId, error) {
  return {
    type: setting_options_action_types_TYPES.SET_ERROR,
    groupId: groupId,
    settingId: settingId,
    error: error
  };
 ...
 * @return The action object.
 */
var revertEditedSetting = function revertEditedSetting(groupId, settingId) {
  return {
    type: setting_options_action_types_TYPES.REVERT_EDITED_SETTING,
    groupId: groupId,
    settingId: settingId
  };
};
 ...
 * @return The action object.
 */
var revertEditedSettingsGroup = function revertEditedSettingsGroup(groupId) {
  return {
    type: setting_options_action_types_TYPES.REVERT_EDITED_SETTINGS_GROUP,
    groupId: groupId
  };
};
 ...
 */
var saveSettingRequest = /*#__PURE__*/function () {
  var _ref7 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee3(groupId, settingId, value, dispatch) {
    var lock, result;
    return regenerator_default().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return dispatch.__unstableAcquireStoreLock(setting_options_STORE_NAME, ['settings', groupId, settingId], {
            exclusive: true
          });
        case 2:
          lock = _context3.sent;
          ...
          _context3.next = 7;
          return (0,api_fetch_build_module/* default */.A)({
            path: "".concat(NAMESPACE, "/settings/").concat(groupId, "/").concat(settingId),
            method: 'PUT',
            data: {
              value: value
            }
        ...
        case 12:
          _context3.prev = 12;
          _context3.t0 = _context3["catch"](4);
          dispatch(setting_options_actions_setError(groupId, settingId, _context3.t0));
          throw _context3.t0;
        case 16:
          _context3.prev = 16;
    ...
    }, _callee3, null, [[4, 12, 16, 20]]);
  }));
  return function saveSettingRequest(_x3, _x4, _x5, _x6) {
 ...
 */
var saveSettingsGroupRequest = /*#__PURE__*/function () {
  var _ref8 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee4(groupId, updates, dispatch) {
    var lock, results, successfulUpdates, errors, error, partialError;
    return regenerator_default().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return dispatch.__unstableAcquireStoreLock(setting_options_STORE_NAME, ['settings', groupId], {
            exclusive: true
          });
        case 2:
          lock = _context4.sent;
          ...
          _context4.next = 7;
          return (0,api_fetch_build_module/* default */.A)({
            path: "".concat(NAMESPACE, "/settings/").concat(groupId, "/batch"),
            method: 'POST',
            data: {
              update: updates
            }
        ...
        case 7:
          ...
          successfulUpdates = [];
          errors = [];
          results.update.forEach(function (result) {
            if ('error' in result && result.error && (0,esm_typeof/* default */.A)(result.error) === 'object') {
              // If the result has an error, collect it
              errors.push({
                id: result.id,
                error: result.error
              });
              dispatch(setting_options_actions_setError(groupId, result.id, result.error));
            } else {
          ...
          error = new Error('Failed to update some settings');
        ...
        case 19:
          ...
          partialError = _context4.t0 instanceof Error && 'settingErrors' in _context4.t0; // All settings failed to update, set the error for the entire group
          if (!partialError) {
            dispatch(setting_options_actions_setError(groupId, null, _context4.t0));
          }
          throw _context4.t0;
        case 24:
          _context4.prev = 24;
    ...
    }, _callee4, null, [[4, 19, 24, 28]]);
  }));
  return function saveSettingsGroupRequest(_x7, _x8, _x9) {
 ...
 * @return The action object.
 */
var saveSettingsGroup = function saveSettingsGroup(groupId, updates) {
  return /*#__PURE__*/function () {
    var _ref10 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee5(_ref9) {
      var dispatch, updatesArray;
      return regenerator_default().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            dispatch = _ref9.dispatch;
            updatesArray = Array.isArray(updates) ? updates : Object.entries(updates).map(function (_ref11) {
            ...
            return _context5.abrupt("return", saveSettingsGroupRequest(groupId, updatesArray, dispatch));
          case 3:
          case "end":
            return _context5.stop();
        }
 ...
 * @return The action object
 */
var saveSetting = function saveSetting(groupId, settingId, value) {
  return /*#__PURE__*/function () {
    var _ref14 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee6(_ref13) {
      var dispatch;
      return regenerator_default().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            dispatch = _ref13.dispatch;
            return _context6.abrupt("return", saveSettingRequest(groupId, settingId, value, dispatch));
          case 2:
          case "end":
            return _context6.stop();
        }
 ...
 * @return The action object.
 */
var saveEditedSettingsGroup = function saveEditedSettingsGroup(groupId) {
  return /*#__PURE__*/function () {
    var _ref16 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee7(_ref15) {
      var select, dispatch, editedSettings;
      return regenerator_default().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            select = _ref15.select, dispatch = _ref15.dispatch;
            editedSettings = select.getEditedSettingIds(groupId).map(function (settingId) {
              return {
                id: settingId,
          ...
          case 4:
            return _context7.abrupt("return", saveSettingsGroupRequest(groupId, editedSettings, dispatch));
          case 5:
          case "end":
            return _context7.stop();
        }
 ...
 * @return The action object.
 */
var saveEditedSetting = function saveEditedSetting(groupId, settingId) {
  return /*#__PURE__*/function () {
    var _ref18 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee8(_ref17) {
      var select, dispatch, editedSettingIds, value;
      return regenerator_default().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            select = _ref17.select, dispatch = _ref17.dispatch;
            // Check if this setting has any edits
            editedSettingIds = select.getEditedSettingIds(groupId);
          ...
          case 4:
            ...
            return _context8.abrupt("return", saveSettingRequest(groupId, settingId, value, dispatch));
          case 6:
          case "end":
            return _context8.stop();
        }
...
var lockActions = (0,actions/* default */.A)();
var __unstableAcquireStoreLock = lockActions.__unstableAcquireStoreLock;
var __unstableReleaseStoreLock = lockActions.__unstableReleaseStoreLock;
 ...
 */
var resolvers_getGroups = function getGroups() {
  return /*#__PURE__*/function () {
    var _ref2 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee(_ref) {
      var dispatch, groups;
      return regenerator_default().wrap(function _callee$(_context) {
 ...
 */
var setting_options_resolvers_getSettings = function getSettings(groupId) {
  return /*#__PURE__*/function () {
    var _ref4 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee2(_ref3) {
      var dispatch, lock, settings;
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 3:
            ...
            _context2.next = 7;
            return (0,api_fetch_build_module/* default */.A)({
              path: "".concat(NAMESPACE, "/settings/").concat(groupId)
            });
          case 7:
          ...
          case 12:
            _context2.prev = 12;
            _context2.t0 = _context2["catch"](4);
            dispatch(setting_options_actions_setError(groupId, null, _context2.t0 instanceof Error ? _context2.t0 : new Error(String(_context2.t0))));
            throw _context2.t0;
          case 16:
            _context2.prev = 16;
            dispatch.__unstableReleaseStoreLock(lock);
 ...
 */
var resolvers_getSetting = function getSetting(groupId, settingId) {
  return /*#__PURE__*/function () {
    var _ref6 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee3(_ref5) {
      var dispatch, lock, setting;
      return regenerator_default().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
          ...
          case 7:
            ...
            return _context3.abrupt("return", setting);
          case 12:
            _context3.prev = 12;
            _context3.t0 = _context3["catch"](4);
            dispatch(setting_options_actions_setError(groupId, settingId, _context3.t0 instanceof Error ? _context3.t0 : new Error(String(_context3.t0))));
            throw _context3.t0;
          case 16:
            _context3.prev = 16;
            dispatch.__unstableReleaseStoreLock(lock);
 ...
 * @param settingId - The setting ID
 */
var resolvers_getSettingValue = function getSettingValue(groupId, settingId) {
  return /*#__PURE__*/function () {
    var _ref7 = (0,asyncToGenerator/* default */.A)(/*#__PURE__*/regenerator_default().mark(function _callee4(args) {
      var setting;
      return regenerator_default().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return resolvers_getSetting(groupId, settingId)(args);
          case 2:
            setting = _context4.sent;
            return _context4.abrupt("return", setting === null || setting === void 0 ? void 0 : setting.value);
          case 4:
          case "end":
            return _context4.stop();
        }
...
function setting_options_reducer_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function setting_options_reducer_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? setting_options_reducer_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : setting_options_reducer_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
 ...
 */
var ensureGroupExists = function ensureGroupExists(obj, groupId) {
  if (!obj[groupId]) {
    obj[groupId] = {};
  }
  return obj[groupId];
 ...
 */
var cleanupEmptyGroups = function cleanupEmptyGroups(obj, groupId) {
  var group = obj[groupId];
  if (group && Object.keys(group).length === 0) {
    delete obj[groupId];
  }
};
var setting_options_reducer_reducer = function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_STATE;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  switch (action.type) {
    case setting_options_action_types_TYPES.RECEIVE_GROUPS:
      return setting_options_reducer_objectSpread(setting_options_reducer_objectSpread({}, state), {}, {
        groups: action.groups
      });
    case setting_options_action_types_TYPES.RECEIVE_SETTINGS:
      {
        var settings = setting_options_reducer_objectSpread({}, state.settings);
        var edits = setting_options_reducer_objectSpread({}, state.edits);
        var errors = setting_options_reducer_objectSpread({}, state.errors);
        var groupSettings = ensureGroupExists(settings, action.groupId);
        action.settings.forEach(function (setting) {
          ...
          [edits, errors].forEach(function (obj) {
            if (obj[action.groupId]) {
              var groupObj = obj[action.groupId];
    ...
    case setting_options_action_types_TYPES.EDIT_SETTING:
      {
        var _groupSettings$action, _edits$action$groupId;
        var _edits = setting_options_reducer_objectSpread({}, state.edits);
        var _groupSettings = state.settings[action.groupId] || {};
        var currentValue = (_groupSettings$action = _groupSettings[action.settingId]) === null || _groupSettings$action === void 0 ? void 0 : _groupSettings$action.value;
        ...
        if (action.value !== currentValue) {
          ...
          var groupEdits = ensureGroupExists(_edits, action.groupId);
          groupEdits[action.settingId] = action.value;
        } else if (((_edits$action$groupId = _edits[action.groupId]) === null || _edits$action$groupId === void 0 ? void 0 : _edits$action$groupId[action.settingId]) !== undefined) {
          // Remove the edit if the value matches the original
          var _groupEdits = _edits[action.groupId];
          if (_groupEdits) {
            delete _groupEdits[action.settingId];
            cleanupEmptyGroups(_edits, action.groupId);
          }
        }
        return setting_options_reducer_objectSpread(setting_options_reducer_objectSpread({}, state), {}, {
          edits: _edits
    ...
    case setting_options_action_types_TYPES.EDIT_SETTINGS:
      {
        var _edits2 = setting_options_reducer_objectSpread({}, state.edits);
        var _groupSettings2 = state.settings[action.groupId] || {};
        var _groupEdits2 = ensureGroupExists(_edits2, action.groupId);

        // Process each setting update in the batch
        action.updates.forEach(function (update) {
          var _groupSettings2$updat;
          var currentValue = (_groupSettings2$updat = _groupSettings2[update.id]) === null || _groupSettings2$updat === void 0 ? void 0 : _groupSettings2$updat.value;
          if (update.value !== currentValue) {
            // Store edit if value changed
            _groupEdits2[update.id] = update.value;
          } else {
            // Remove edit if value matches original
            delete _groupEdits2[update.id];
          }
        });
        cleanupEmptyGroups(_edits2, action.groupId);
        return setting_options_reducer_objectSpread(setting_options_reducer_objectSpread({}, state), {}, {
          edits: _edits2
        });
      }
    case setting_options_action_types_TYPES.SET_SAVING:
      {
        var isSaving = setting_options_reducer_objectSpread({}, state.isSaving);
        if (action.settingId === null) {
          ...
          var groupSavingState = ensureGroupExists(isSaving.settings, action.groupId);
    ...
    case setting_options_action_types_TYPES.SET_ERROR:
      {
        var _errors = setting_options_reducer_objectSpread({}, state.errors);
        var groupErrors = ensureGroupExists(_errors, action.groupId);
        if (action.settingId === null) {
          // Handle group-level errors
          if (action.error === null) {
            delete _errors[action.groupId];
          } else {
          ...
          cleanupEmptyGroups(_errors, action.groupId);
        } else {
    ...
    case setting_options_action_types_TYPES.REVERT_EDITED_SETTING:
      {
        var _edits3 = setting_options_reducer_objectSpread({}, state.edits);
        var _errors2 = setting_options_reducer_objectSpread({}, state.errors);

        // Remove the edit for the specified setting
        if (_edits3[action.groupId]) {
          var _groupEdits3 = _edits3[action.groupId];
          if (_groupEdits3) {
            delete _groupEdits3[action.settingId];
            cleanupEmptyGroups(_edits3, action.groupId);
          }
        }

        // Clear any errors for the setting
        if (_errors2[action.groupId]) {
          var _groupErrors = _errors2[action.groupId];
          if (_groupErrors) {
            delete _groupErrors[action.settingId];
            cleanupEmptyGroups(_errors2, action.groupId);
          }
        }
        return setting_options_reducer_objectSpread(setting_options_reducer_objectSpread({}, state), {}, {
          edits: _edits3,
    ...
    case setting_options_action_types_TYPES.REVERT_EDITED_SETTINGS_GROUP:
      {
        var _edits4 = setting_options_reducer_objectSpread({}, state.edits);
        var _errors3 = setting_options_reducer_objectSpread({}, state.errors);

        // Remove all edits and errors for the entire group
        delete _edits4[action.groupId];
        delete _errors3[action.groupId];
        return setting_options_reducer_objectSpread(setting_options_reducer_objectSpread({}, state), {}, {
          edits: _edits4,
          errors: _errors3
        });
...
/* harmony default export */ const setting_options_reducer = (setting_options_reducer_reducer);
...
var setting_options_STORE_NAME = 'wc/admin/settings-options';
var setting_options_store = (0,redux_store/* default */.A)(setting_options_STORE_NAME, {
  reducer: setting_options_reducer,
  actions: setting_options_actions_namespaceObject,
  controls: data_controls_build_module/* controls */.ne,
  selectors: setting_options_selectors_namespaceObject,
  resolvers: setting_options_resolvers_namespaceObject
});
(0,data_build_module/* register */.kz)(setting_options_store);
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");
;// ../../packages/js/data/src/settings/with-settings-hydration.tsx
...
;// ../../packages/js/data/src/onboarding/with-onboarding-hydration.tsx
...
;// ../../packages/js/data/src/user/with-current-user-hydration.tsx
...
;// ../../packages/js/data/src/plugins/with-plugins-hydration.tsx
...
;// ../../packages/js/data/src/options/with-options-hydration.tsx
...
;// ../../packages/js/data/src/settings/use-settings.ts
...
;// ../../packages/js/data/src/user/use-user-preferences.ts
...
;// ../../packages/js/data/src/user/use-user.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/onboarding/utils.ts
...
function store_aware_utils_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function store_aware_utils_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? store_aware_utils_ownKeys(Object(t), !0).forEach(function (r) {
      _defineProperty(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : store_aware_utils_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
...
function getLeaderboard(options) {
  ...
  var leaderboardQuery = store_aware_utils_objectSpread(store_aware_utils_objectSpread({}, filterQuery), {}, {
  ...
  if (isResolving('getItems', [endpoint, leaderboardQuery])) {
    return store_aware_utils_objectSpread(store_aware_utils_objectSpread({}, response), {}, {
      isRequesting: true
    });
...
;// ../../packages/js/data/src/reports/utils.ts
...
;// ../../packages/js/data/src/export/constants.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/export/utils.ts
/**
 * External dependencies
 */
...
;// ../../packages/js/data/src/export/selectors.ts
/**
 * Internal dependencies
 */
...
;// ../../packages/js/data/src/export/action-types.ts
...
;// ../../packages/js/data/src/export/actions.ts
...
;// ../../packages/js/data/src/export/reducer.ts
...
;// ../../packages/js/data/src/export/index.ts
/**
 * External dependencies
 */
